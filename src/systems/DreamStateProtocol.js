...
export default class DreamStateProtocol {
    ...
    startDeathDream(deathData) {
        ...
        // FIX: Don't enter dream state if game is paused
        if (this.scene.pauseSystem?.paused || this.scene.isExchangePaused || this.scene.isContractPaused) {
            console.log('[DreamState] Death occurred while game paused - deferring dream');
            return;
        }
