    ...
    constructor(scene) {
        ...
        this.SLOTS = {
            TOP_LEFT: {
                ...
                SYNTROPY: { x: this.margin, y: 120 },
                CONVERGENCE: { x: this.margin, y: 140 },
                SYNTHESIS: { x: this.margin, y: 160 },
                PATTERN: { x: this.margin, y: 180 },
                VOID_COHERENCE: { x: this.margin, y: 200 },
                CHRONO_LOOP: { x: this.margin, y: 220 },
                CAUSAL_LINK: { x: this.margin, y: 240 },
                TEMPORAL_REWIND: { x: this.margin, y: 260 },
            },
            TOP_CENTER: {
